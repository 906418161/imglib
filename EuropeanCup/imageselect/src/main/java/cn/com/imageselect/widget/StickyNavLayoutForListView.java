...
public class StickyNavLayoutForListView extends LinearLayout {
    ...
    public StickyNavLayoutForListView(Context context) {
        this(context, null);
    }

    public StickyNavLayoutForListView(Context context, AttributeSet attrs) {
        super(context, attrs);
