...
//    private float mMinTextSize = 16;
    ...
    private void performSelect() {
        if (mSelectListener != null) {
            ...
            mSelectListener.onIndex(mCurrentSelected);
        }
    }
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.datepicker));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.balckgray));
    }
