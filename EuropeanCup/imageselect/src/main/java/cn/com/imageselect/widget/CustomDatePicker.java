...
public class CustomDatePicker {
    ...
    private LinearLayout left_pv, right_pv;
    ...
    private void initView() {
        ...
        left_pv = datePickerDialog.findViewById(R.id.left_pv);
        right_pv = datePickerDialog.findViewById(R.id.right_pv);
    ...
    public void setShowLeft(boolean isShow) {
        left_pv.setVisibility(isShow ? View.VISIBLE : View.GONE);
    }

    public void setShowRight(boolean isShow) {
        right_pv.setVisibility(isShow ? View.VISIBLE : View.GONE);
    }
